...
public class Amphibious extends Vehicle implements  Motorized{
    ...
    public Amphibious(String modelName, int maxPassengers, int maxSpeed, int numOfWheels, boolean sailWithWind, String countryFlag) {
        ...
        //landVehicle = new LandVehicle(modelName, maxPassengers, maxSpeed, numOfWheels, roadType);
        // marineVehicle = new MarineVehicle(modelName, maxPassengers, maxSpeed, sailWithWind, countryFlag);
    }
